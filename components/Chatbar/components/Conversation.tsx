  ...
  return (
    <div className="relative flex items-center">
      {isRenaming && selectedConversation?.id === conversation.id ? (
        <div className="flex w-full items-center gap-3 rounded-lg text-black bg:text-white bg-neutral-300 dark:bg-[#343541]/90 p-3">
          <IconMessage size={18} />
          <input
        ...
        <button
          className={`flex w-full cursor-pointer items-center gap-3 rounded-lg p-3 text-sm transition-colors duration-200 text-black dark:text-gray-300 hover:bg-gray-500/10 dark:hover:bg-[#343541]/90 ${
            messageIsStreaming ? 'disabled:cursor-not-allowed' : ''
          } ${
            selectedConversation?.id === conversation.id
              ? 'bg-neutral-300 dark:bg-[#343541]/90'
              : ''
          }`}
